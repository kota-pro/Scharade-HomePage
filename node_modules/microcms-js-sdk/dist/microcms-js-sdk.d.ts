...
declare const createClient: ({ serviceDomain, apiKey, retry: retryOption, }: MicroCMSClient) => {
    ...
    create: <T_5 extends Record<string | number, any>>({ endpoint, contentId, content, isDraft, isClosed, customRequestInit, }: CreateRequest<T_5>) => Promise<WriteApiRequestResult>;
